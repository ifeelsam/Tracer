    ...
    <main className="dashboard-shell">
      <section className="frame mx-auto grid max-w-[1280px] grid-cols-1 gap-0 lg:grid-cols-[1.35fr_0.65fr]">
        <div className="frame-header border-b border-r-0 p-6 lg:border-b-0 lg:border-r">
          ...
          <h1 className="headline mt-8 max-w-4xl text-5xl leading-none md:text-7xl">
          ...
          <div className="mt-8 flex flex-wrap gap-2">
            <a className="nav-chip" href="/login">
              Open Console
            </a>
            <a className="nav-chip" href="/app">
              Explore Dashboard
            </a>
          </div>
        </div>
        <div className="p-6">
          <div className="label text-[var(--foreground-muted)]">Execution Stack</div>
